...
local treeIdle = Sprite.load("auricIdle", 1, 11, 27)
local treeSpawn = Sprite.load("auricSpawn", 3, 11, 27)
local treeMask = Sprite.load("auricMask", 1, 11, 27)
local shing = Sound.load("tree.ogg")
...
local leaf = Sprite.load("leafEf", 1, 2, 2)
...
local treegen = Buff.new("Auric Blessing")
	treegen.sprite = Sprite.load("treeHP", 1, 10, 0)
local treeArmor = Buff.new("Auric Distinction")
	treeArmor.sprite = Sprite.load("treeShield", 1, 10, 0)
